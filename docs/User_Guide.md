...
> ⚠ 此功能尚未经过完整测试。如遇到问题，请打开浏览器开发者工具（F12 → Console），复制完整日志后到 [GitHub Issues](https://github.com/Silentely/eSIM-Tools/issues) 提交反馈。
...
此方式无需短信验证码，跳过 reserve/swap 流程，直接获取 QR 码。
