...
### 步骤4: 短信验证码激活eSIM
1. 点击"短信验证码激活"按钮
2. 系统自动完成：发送短信验证码 → 验证 → 预订eSIM → SIM交换
3. 输入收到的短信验证码并提交
4. 系统将自动执行完整的激活流程（无需手动前往Giffgaff网站）

> **注意**: 手动激活方式已于2025年10月8日停用，当前仅支持短信验证码自动激活。

### 步骤5: 获取二维码
1. 激活完成后系统自动生成LPA字符串和二维码
2. 保存二维码图片或复制LPA字符串到支持eSIM的设备
